...
<div class="max-w-2xl mx-auto px-4 py-10">
  ...
  <form action="../app/process_register.php" method="POST" class="bg-white p-6 rounded-xl shadow-lg border border-indigo-300 space-y-4">
    ...
    <div class="flex items-center gap-3">
      ...
      <a href="login.php" class="text-sm text-indigo-400 hover:bg-indigo-500">Sudah punya akun? Login</a>
    </div>
  </form>
</div>
