...
<main class="flex-1 bg-gray-50 min-h-screen p-8">
  <div class="max-w-4xl mx-auto">
    ...
    <!-- Flash -->
    <?php if ($flash): ?>
      <div class="mb-6 rounded-md bg-indigo-50 p-4 border border-indigo-100">
        <p class="text-sm text-indigo-800"><?= htmlspecialchars($flash) ?></p>
      </div>
    <?php endif; ?>
    ...
    <div class="bg-white shadow rounded-lg">
      ...
      <form action="/Web1/app/process_create_user.php" method="post" class="px-6 py-6 space-y-6">
        ...
        <button type="submit"
          class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-md shadow">
            ...
            <a href="/Web1/public/admin/role_management.php"
