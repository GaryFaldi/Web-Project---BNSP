<?php
// Base URL relatif ke root URL website (sesuai direktori htdocs/XAMPP)
// Gunakan '/Web1/public' karena project ada di c:\xampp\htdocs\Web1\public
$base = '/Web1/public';
...
<aside class="w-64 bg-white border-r hidden md:block">
  ...
  <div class="border-t p-4 text-sm text-gray-600 space-y-3">
    <a href="<?= $base ?>/dashboard.php" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-50 text-gray-700 transition">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
