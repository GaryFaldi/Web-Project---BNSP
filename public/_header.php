...
function dashboard_link_for_role() {
    ...
    return 'user/users_dashboard.php'; // atau 'users/'
}
?>
<!doctype html>
<html lang="id">
  <head>
    ...
    <title>UPN Veteran Yogyakarta - Blogspot</title>
  ...
  <body class="min-h-screen flex flex-col bg-gray-50 text-gray-800">
    <header class="bg-indigo-600 text-white shadow">
      <div class="page-container px-4 py-4 flex items-center justify-between">
        <a href="dashboard.php" class="text-xl font-semibold">UPN Veteran Yogyakarta - Blogspot</a>

        <nav class="flex items-center gap-4">
          <a href="dashboard.php"
             class="<?= $current === 'dashboard.php' ? 'font-semibold text-white' : 'hover:opacity-90' ?>">
            Beranda
          </a>
