...
<main class="flex-1 p-8 bg-gray-50 min-h-screen">
  <div class="max-w-6xl mx-auto">
    ...
    <!-- Flash -->
    <?php if ($flash): ?>
      <div class="mb-6 rounded-lg p-4 bg-indigo-50 border border-indigo-100">
        <p class="text-sm text-indigo-800"><?= strip_tags($flash) ?></p>
      </div>
    <?php endif; ?>
      ...
      <div class="px-4 py-3 sm:px-6 flex items-center justify-between">
        ...
        <!-- tambah user -->
         <p class="mt-4 text-right">
            <a href="/Web1/public/admin/add_user.php" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
                Tambah User
            </a>
        </p>
        <!-- end -->
              ...
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                  ...
                  <div class="flex items-center gap-3">
                    <!-- form update role -->
                    <form method="post" action="/Web1/app/process_update_role.php" class="flex items-center gap-3">
                    ...
                    <!-- form delete user -->
                    <form method="post" action="/Web1/app/process_delete_user.php" class="inline">
                      <input type="hidden" name="user_id" value="<?= $row['id'] ?>">
                      <input type="hidden" name="csrf" value="<?= $csrf_token ?>">
                      <button type="submit"
