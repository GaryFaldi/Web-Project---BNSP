...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
  <div class="md:col-span-2">
    ...
    <!-- status form message  -->
    <?php if ($success === 1): ?>
      <div class="mt-4 p-3 rounded bg-indigo-50 border border-indigo-200 text-indigo-700">Terima kasih — pesan Anda sudah terkirim.</div>
...
<script>
  ...
  document.getElementById('copyAddressBtn').addEventListener('click', function() {
    ...
    navigator.clipboard.writeText(text).then(() => {
      ...
      setTimeout(() => this.classList.remove('ring-2', 'ring-indigo-300'), 800);
    }, () => {
